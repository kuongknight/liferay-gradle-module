...
/**
 * Provides the local service interface for AdvPackage. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AdvPackageLocalServiceUtil
...
public interface AdvPackageLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AdvPackageLocalServiceUtil} to access the adv package local service. Add custom service methods to {@link com.bportal.kernel.service.impl.AdvPackageLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public AdvPackage addAdvPackage(AdvPackage advPackage);

	public AdvPackage addOrUpdate(long packageId, long layoutId,
		long templateId, java.lang.String packageName,
		java.lang.String description, Date beginDate, Date expiredDate,
	...
	*/
	public AdvPackage createAdvPackage(long advPackageId);
	...
	*/
	...
	public AdvPackage deleteAdvPackage(AdvPackage advPackage);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public AdvPackage deleteAdvPackage(long advPackageId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AdvPackage fetchAdvPackage(long advPackageId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AdvPackage getAdvPackage(long advPackageId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public AdvPackage updateAdvPackage(AdvPackage advPackage);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AdvPackage> getAdvPackages(int start, int end);
